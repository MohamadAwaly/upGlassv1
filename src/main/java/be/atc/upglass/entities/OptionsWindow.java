package be.atc.upglass.entities;
...
public class OptionsWindow implements Serializable {
    ...
    @OneToMany( mappedBy = "optionsWindow", cascade = { CascadeType.PERSIST, CascadeType.MERGE }, fetch = FetchType.LAZY )
    ...
    @Override public boolean equals( Object o ) {
        ...
        return idOptionsWindow == that.idOptionsWindow && name.equals( that.name ) && Objects.equals(
                windowOptionWindows, that.windowOptionWindows );
    }
